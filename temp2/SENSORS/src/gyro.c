...
{
    return gyroCalibration.cycleCount <= 10;
...
Axis3i16 acc_data_test[3];
Axis3i16 gyro_data_test[3];	
Axis3i16 mag_data_test[3];
...
//		return;
//
	MPU9250_Get3AxisGyroRawData(&gyroADCRaw);
//	MPU9250_Get9AxisRawData(acc_data_test,gyro_data_test,mag_data_test);
