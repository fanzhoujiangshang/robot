...
Axis3i16  test_accel_data1[3];
Axis3i16	test_gyro_data1[3];
Axis3i16	test_mag_data1[3];
...
//		return;
//	}
//	MPU9250_Get9AxisRawData(test_accel_data1, test_gyro_data1, test_mag_data1);
	
	MPU9250_Get3AxisAccelRawData(&accADCRaw);	
